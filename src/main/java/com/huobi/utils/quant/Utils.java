...
import static com.huobi.utils.quant.Constants.*;
...
public class Utils {
    ...
    public static double[] toDoubleArray(List<StockData> stockDatas,String column){
        ...
        double[] doubles = toDoubleArray(values);
        return doubles;
    }
    ...
    public static List<String> getYearBetween(String startDate, String stopDate) {
        ...
        DateTime start = new DateTime(str2Date(startDate,"yyyyMMdd"));
        DateTime stop = new DateTime(str2Date(stopDate,"yyyyMMdd"));
    ...
    public static Map<String,String> toMap(StockData stockData){
        ...
        result.put("date", formatDate(stockData.date,"yyyyMMdd"));
        return result;
    }
